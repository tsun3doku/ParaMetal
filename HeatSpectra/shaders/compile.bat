...
C:/VulkanSDK/1.3.283.0/Bin/glslc.exe lighting.vert -o composite_vert.spv
C:/VulkanSDK/1.3.283.0/Bin/glslc.exe lighting.frag -o composite_frag.spv

C:/VulkanSDK/1.3.283.0/Bin/glslc.exe heat_tetra.comp -o heat_tetra_comp.spv
C:/VulkanSDK/1.3.283.0/Bin/glslc.exe heat_surface.comp -o heat_surface_comp.spv
C:/VulkanSDK/1.3.283.0/Bin/glslc.exe heat_source.comp -o heat_source_comp.spv
