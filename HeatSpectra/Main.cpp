...
private:
    ...
    void drawFrame() {
        ...
        //SSAOKernelBufferObject ssaoKernel{}; //new
        //uniformBufferManager.updateSSAOKernelBuffer(currentFrame, camera, ssaoKernel); //new
        ...
        VkCommandBuffer commandBuffersToSubmit[] = { gbuffer.getCommandBuffers()[currentFrame] };
